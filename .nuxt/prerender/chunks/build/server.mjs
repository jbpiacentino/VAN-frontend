import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, defineComponent, shallowRef, h, resolveComponent, getCurrentInstance, computed, ref, Suspense, Fragment, useSSRContext, createApp, provide, shallowReactive, watch, mergeProps, withCtx, createTextVNode, unref, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, toRef, isRef, defineAsyncComponent, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'file:///Users/jb/code/VAN-frontend/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/jb/code/VAN-frontend/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/jb/code/VAN-frontend/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/jb/code/VAN-frontend/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/jb/code/VAN-frontend/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file:///Users/jb/code/VAN-frontend/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, withTrailingSlash, withoutTrailingSlash } from 'file:///Users/jb/code/VAN-frontend/node_modules/ufo/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/jb/code/VAN-frontend/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DZ--RzDt.mjs')
  },
  {
    name: "program",
    path: "/program",
    component: () => import('./program-DvT78_q3.mjs')
  },
  {
    name: "solutions",
    path: "/solutions",
    component: () => import('./solutions-CCDpD_sj.mjs')
  },
  {
    name: "van-finder",
    path: "/van-finder",
    component: () => import('./van-finder-BKJCXOX1.mjs')
  },
  {
    name: "vendors-slug",
    path: "/vendors/:slug()",
    component: () => import('./_slug_-BSKlTO4o.mjs')
  }
];
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</nav><div class="inline-flex items-center gap-3 text-sm text-base-content/70"><label for="theme-select" class="font-medium">Theme</label><select id="theme-select" class="select select-sm border-base-300 bg-base-100"><!--[-->`);
      ...
      _push(`<!--]--></select></div></div></header><main class="mx-auto w-[min(1080px,92vw)] flex-1 py-10 max-[720px]:pt-6">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CLMinL-l.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BQPlwbCU.mjs'));
...
export { __nuxt_component_0 as _, useNuxtApp as a, asyncDataDefaults as b, createError as c, useRequestFetch as d, entry_default as default, fetchDefaults as f, useRoute as u };
