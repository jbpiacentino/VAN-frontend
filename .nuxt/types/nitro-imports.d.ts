declare global {
  ...
  const buildMembershipMap: typeof import('../../server/utils/strapi').buildMembershipMap
  ...
  const fuzzyIncludes: typeof import('../../server/utils/strapi').fuzzyIncludes
  ...
  const getStrapiConfig: typeof import('../../server/utils/strapi').getStrapiConfig
  ...
  const levenshtein: typeof import('../../server/utils/strapi').levenshtein
  const mapVendor: typeof import('../../server/utils/strapi').mapVendor
  const markdownToPreviewText: typeof import('../../server/utils/strapi').markdownToPreviewText
  const mediaUrl: typeof import('../../server/utils/strapi').mediaUrl
  const nitroPlugin: typeof import('../../node_modules/nitropack/dist/runtime/internal/plugin').nitroPlugin
  const normalizeComponentStringList: typeof import('../../server/utils/strapi').normalizeComponentStringList
  ...
  const relationFirst: typeof import('../../server/utils/strapi').relationFirst
  const relationItems: typeof import('../../server/utils/strapi').relationItems
