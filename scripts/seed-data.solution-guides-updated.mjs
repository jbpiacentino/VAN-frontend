  ...
  'solution-guides': [
    {
      ...
      data: {
        ...
        workflow: 'draft',
        summary: `Production-ready **private cloud landing zone blueprint** for Vates VMS, covering topology, security baselines, operational guardrails, and scalable multi-site rollout patterns.`,
        body: `## Purpose

This guide defines a structured approach to designing and deploying a production-grade private cloud landing zone built on **Vates VMS**.

It focuses not only on initial setup, but on long-term operational durability, governance alignment, and repeatability across clusters and sites.

## Scope

The landing zone model includes:

- Cluster topology and role separation
- Management plane isolation and network segmentation
- Identity, RBAC, and policy baseline design
- Backup, disaster recovery, and observability integration
- Change management and lifecycle governance

## Deployment Phases

### 1. Foundation
Infrastructure validation, baseline hardening, and core service enablement.

### 2. Control & Governance
Policy definition, access boundaries, and operational guardrails.

### 3. Operational Readiness
Backup validation, monitoring activation, runbook creation, and drill planning.

### 4. Scale-Out
Replication of validated patterns to additional clusters or regions using controlled rollout waves.

## Operational Outcomes

By following this guide, teams achieve:
...
- A scalable blueprint reusable across environments`
      }
    },
    {
      ...
      data: {
        ...
        workflow: 'draft',
        summary: `Structured **observability and capacity governance playbook** transforming telemetry into measurable optimization cycles, forecast confidence, and cost-aware platform operations.`,
        body: `## Purpose

This playbook establishes a repeatable framework for turning raw infrastructure telemetry into structured decisions across performance, utilization, and financial governance.

It aligns engineering, operations, and finance around measurable optimization loops.

## Observability Foundations

- Standardized telemetry collection and normalization
- Ownership model for tags and service mapping
- Data retention and quality validation controls

## KPI & Signal Design

- Capacity headroom and saturation indicators
- Performance degradation detection
- Noisy-neighbor and imbalance analysis
- Exception-based alerting to reduce operational noise

## Governance Loop

### Weekly
Signal triage and risk prioritization.

### Monthly
Rightsizing validation, anomaly review, and backlog tracking.

### Quarterly
Forecast recalibration and budget alignment.

## Reporting Model

- Executive summary: trend signals and material risks
- Platform detail: remediation backlog and accountability
- Evidence trail: decisions, exceptions, and validation checkpoints

## Expected Outcomes

- Reduced overprovisioning and waste
- Improved forecast confidence
- Stronger collaboration between IT and finance
- Continuous improvement culture embedded into operations`
      }
    }
  ],
